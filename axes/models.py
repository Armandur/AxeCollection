...
class Manufacturer(models.Model):
    ...
    def total_buy_value(self):
        return (
            self.transactions.filter(type="KÖP").aggregate(total=Sum("price"))["total"]
            or 0
        )
    ...
    def total_buy_value_including_sub_manufacturers(self):
        ...
        return (
            self.transactions_including_sub_manufacturers.filter(type="KÖP").aggregate(
                total=Sum("price")
            )["total"]
            or 0
        )
    ...
    def total_sale_value(self):
        return (
            self.transactions.filter(type="SÄLJ").aggregate(total=Sum("price"))["total"]
            or 0
        )
    ...
    def total_sale_value_including_sub_manufacturers(self):
        ...
        return (
            self.transactions_including_sub_manufacturers.filter(type="SÄLJ").aggregate(
                total=Sum("price")
            )["total"]
            or 0
        )
...
class Axe(models.Model):
    ...
    def total_buy_shipping(self):
        return (
            self.transactions.filter(type="KÖP").aggregate(total=Sum("shipping_cost"))[
                "total"
            ]
            or 0
        )
    ...
    def total_sale_shipping(self):
        return (
            self.transactions.filter(type="SÄLJ").aggregate(total=Sum("shipping_cost"))[
                "total"
            ]
            or 0
        )
