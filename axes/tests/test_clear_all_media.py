...
class ClearAllMediaCommandTest(TestCase):
    ...
    def setUp(self):
        ...
        self.test_file3 = os.path.join(self.temp_dir, "manufacturer_images", "test3.jpg")
    ...
    def test_clear_all_media_with_nonexistent_files(self, mock_settings):
        ...
        StampImage.objects.create(
            stamp=stamp,
            image="nonexistent2.jpg",
            order=1
        )
        
        ManufacturerImage.objects.create(
            manufacturer=manufacturer,
            image="nonexistent3.jpg"
        )
    ...
    def test_clear_all_media_preserves_database_records(self, mock_settings):
        ...
        self.assertTrue(ManufacturerImage.objects.filter(id=manufacturer_image.id).exists())
