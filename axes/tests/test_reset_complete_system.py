...
class ResetCompleteSystemCommandTest(TestCase):
    ...
    def test_reset_complete_system_command(self):
        ...
        self.assertTrue(ManufacturerLink.objects.filter(manufacturer=manufacturer).exists())
        ...
        self.assertFalse(ManufacturerImage.objects.filter(manufacturer=manufacturer).exists())
        self.assertFalse(ManufacturerLink.objects.filter(manufacturer=manufacturer).exists())
