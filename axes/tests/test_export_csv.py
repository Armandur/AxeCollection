...
class ExportCSVCommandTest(TestCase):
    ...
    def setUp(self):
        ...
        self.axe = Axe.objects.create(
            manufacturer=self.manufacturer, model="Test Yxa", comment="Test beskrivning"
        )
        ...
        self.measurement = Measurement.objects.create(
            axe=self.axe, name="Längd", value=50.0, unit="cm"
        )

        self.axe_image = AxeImage.objects.create(
            axe=self.axe, image="test_image.jpg", order=1
        )
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            try:
                ...
                for filename in expected_files:
                    ...
                    self.assertTrue(
                        os.path.exists(file_path), f"Filen {filename} skapades inte"
                    )
    ...
    def test_export_transactions(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            try:
                ...
                self.assertEqual(
                    rows[1][9], "500.00"
                )  # price (ändra från "500" till "500.00")
    ...
    def test_clean_text_method(self):
        ...
        self.assertEqual(
            command.clean_text("  Text   med   extra   whitespace  "),
            "Text med extra whitespace",
        )
