...
class UpdatePictogramsCommandTest(TestCase):
    ...
    def test_update_pictograms_with_multiple_manufacturers(self, mock_settings):
        ...
        manufacturer1 = Manufacturer.objects.create(
            name="Test Tillverkare 1", information="Test information 1"
        )

        manufacturer2 = Manufacturer.objects.create(
            name="Test Tillverkare 2", information="Test information 2"
        )

        manufacturer3 = Manufacturer.objects.create(
            name="Test Tillverkare 3", information="Test information 3"
        )

        # Skapa bilder för tillverkare
        ManufacturerImage.objects.create(manufacturer=manufacturer1, image="test1.jpg")

        ManufacturerImage.objects.create(manufacturer=manufacturer2, image="test2.jpg")
    ...
    def test_update_pictograms_with_nonexistent_files(self, mock_settings):
        ...
        ManufacturerImage.objects.create(
            manufacturer=manufacturer, image="nonexistent.jpg"
        )
    ...
    def test_update_pictograms_with_subdirectories(self, mock_settings):
        ...
        ManufacturerImage.objects.create(
            manufacturer=manufacturer1, image="subdir1/subtest1.jpg"
        )

        ManufacturerImage.objects.create(
            manufacturer=manufacturer2, image="subdir2/subtest2.jpg"
        )
